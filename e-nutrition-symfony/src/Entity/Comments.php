...
class Comments
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=SuccessStory::class, inversedBy="comments")
    ...
    public function getSuccess(): ?SuccessStory
    {
        return $this->success;
    }

    public function setSuccess(?SuccessStory $success): self
    {
