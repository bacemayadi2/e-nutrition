...
public class PlatsView extends AbstractEntityView {
    ...
    ArrayList<Plat> plats =sP.getAllPlats();
    ...
    public PlatsView(Entity appEntity, Node viewNode) {
        super(appEntity);
        ...
        filterButton.addActionListener(evt -> {
            ...
            if (action != null) {
                action.fireEvent(appEntity, PlatsView.this);
            }
        });
        ...
        allRestaurantsCnt.add(BorderLayout.CENTER, createallplats(plats));
    ...
    private Container createallplats(ArrayList<Plat> plats) {
        ...
        {
                        allRestsCnt.add(new onePlatView((Entity) plats.get(i), viewNode));
        }
