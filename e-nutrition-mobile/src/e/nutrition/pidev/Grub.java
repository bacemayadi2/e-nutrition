...
public class Grub extends ApplicationController {
    ...
    public void actionPerformed(ControllerEvent evt) {
        if (evt instanceof ApplicationController.StartEvent) {
            evt.consume();
    ...
    public void init(Object context) {
        ...
        dispatchEvent(new ApplicationController.InitEvent(context));
    }
    ...
    public void stop() {
        ...
        dispatchEvent(new ApplicationController.StopEvent());
    ...
    public void start() {
        showCurrentForm();
        if (current == null){
            dispatchEvent(new ApplicationController.StartEvent());
        }
    }
